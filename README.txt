The description of Ant, Maven, and Gradle integration is available at https://docs.parasoft.com/display/JTEST20261/Integrating+with+Build+Systems
...
1. Configure your Maven setup by following the Jtest User Guide:
   https://docs.parasoft.com/display/JTEST20261/Configuring+the+Jtest+Plugin+for+Maven
...
For more information see:
   https://docs.parasoft.com/display/JTEST20261/Testing+and+Analysis+with+Maven
   https://docs.parasoft.com/display/JTEST20261/Testing+and+Analysis+with+Gradle
...
For more information see https://docs.parasoft.com/display/JTEST20261/Application+Coverage
...
1. Configure desired settings for UTA Bulk Creation in the jtestcli.properties file.
    ...
    For more information see:
    https://docs.parasoft.com/display/JTEST20261/Unit+Test+Creation+Settings

2. Set up version control in advance to easily review and manage the changes.

    For more information, see:
    https://docs.parasoft.com/display/JTEST20261/Source+Control+Settings
...
For more information see:
https://docs.parasoft.com/display/JTEST20261/Unit+Test+Creation
https://docs.parasoft.com/display/JTEST20261/Running+Unit+Test+Creation
